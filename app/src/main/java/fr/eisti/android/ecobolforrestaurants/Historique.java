...
public class Historique extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myCommand= Historique.DataProvider.getInfo();
        ...
        stock.setColorFilter(Color.parseColor("#7CB342"));
        stockText.setTextColor(Color.parseColor("#7CB342"));
        ...
        commandes.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(Historique.this,Commandes.class));
        ...
        promos.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Historique.this,Promos.class));
    ...
    class MyAdapter extends BaseExpandableListAdapter {
        ...
        public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent)
        {
            ...
            if(convertView== null)
            {
                ...
                convertView= inflater.inflate(R.layout.historique_header,null);

            }
            TextView txt = (TextView)convertView.findViewById(R.id.idTitle);
            txt.setTypeface(null, Typeface.BOLD);

            if (title.contains("Refusée"))
            {
        ...
        public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent)
        {
            ...
            {
                LayoutInflater inflater= (LayoutInflater)this.ctx.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
                convertView = inflater.inflate(R.layout.historique_children,null);
    ...
    static class DataProvider {
        public static HashMap<String, List<String>> getInfo()
        {
            ...
            ChildDetails3.add("Burger classique                                                                                                                     13,00€");
            ChildDetails3.add("Boeufs");
            ChildDetails3.add("Frites");
            ChildDetails3.add("+ Glace vanille");
            ChildDetails3.add("Burger classique                                                                                                                     12,00€");
            ChildDetails3.add("Poulet");
            ChildDetails3.add("Frites");



            HeaderDetails.put("Martin (Délivrée à 19h34)                                25,00€",ChildDetails1);
            HeaderDetails.put("Alex (Refusée)                                                        25,00€",ChildDetails2);
            HeaderDetails.put("René (Délivrée à 19h21)                                  125,00€",ChildDetails3);
